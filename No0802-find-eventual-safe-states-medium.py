# -*- coding: utf-8 -*-
"""
Created on Sat Apr 16 11:10:23 2022
...
if __name__ == "__main__":
    ...
    tstart = time.time()
    ans = sln.eventualSafeNodes(graph)
    tstop  = time.time()
    print('ans={0}, tcost={1:4.2f}sec'.format(ans,tstop-tstart))