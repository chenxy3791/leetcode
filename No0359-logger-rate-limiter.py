# -*- coding: utf-8 -*-
"""
Created on Thu Apr  8 08:06:17 2021
...
class Logger:
    ...
    def printMsgbuf(self) -> None:
        print('The content in msgbuf is:')
        for msg in self.msgbuf:
            print(msg, self.msgbuf[msg])
    ...
    def shouldPrintMessage(self, timestamp: int, message: str) -> bool:
        ...
        """
        if message in self.msgbuf:
            if timestamp >= self.msgbuf[message]:
                self.msgbuf[message] = timestamp + 10
                return True
            else:
                return False
        else:
